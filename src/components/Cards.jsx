...
function Cards() {
  return (
    <div className="w-full h-screen text-white bg-zinc-800 ">
        <div className="cards flex mt-24 gap-8 p-8">
            <div className="w-full relative h-[60vh] bg-[#004D43] rounded-3xl"><div>
            <svg className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" width="140" height="80" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button className="rounded-full border-zinc-100 border-[1px] mt-72 ml-6 p-2 uppercase text-[1vw]">business bootcamp alumni</button>                   
                                </div>
            <div className="w-1/2 h-[60vh] bg-zinc-900 rounded-3xl relative">
            <h1 className="text-[4vw] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">Clutch</h1>
            <button className="rounded-full border-zinc-100 border-[1px] mt-72 ml-6 p-2 uppercase text-[1vw]">ratinf5.0 on clutch</button>
            </div>
             <div className="w-1/2 h-[60vh] bg-zinc-900 rounded-3xl relative">
             <img className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" width="100" alt="" />
             <button className="rounded-full border-zinc-100 border-[1px] mt-72 ml-6 p-2 uppercase text-[1vw]">business bootcamp alumni</button>
             </div>
